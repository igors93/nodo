...
GovernanceEvidenceValidationResult::accepted() {
...
GovernanceEvidenceValidationResult GovernanceEvidenceValidationResult::rejected(
    GovernanceEvidenceValidationStatus status, std::string reason) {
  GovernanceEvidenceValidationResult r;
  r.m_status = status;
...
GovernanceEvidenceValidationStatus
GovernanceEvidenceValidationResult::status() const {
  return m_status;
}
const std::string &GovernanceEvidenceValidationResult::reason() const {
  return m_reason;
}

static GovernanceEvidenceValidationStatus
mapBridgeStatus(GovernanceApprovalBridgeStatus s) {
  switch (s) {
...
GovernanceEvidenceValidationResult
TreasuryGovernanceEvidenceValidator::validateGovernanceContext(
  ...
  if (!bridgeResult.isAccepted()) {
    return GovernanceEvidenceValidationResult::rejected(
        ...
        "TreasuryGovernanceEvidenceValidator: bridge rejected governance "
        "context: " +
            bridgeResult.reason());
  }
  ...
  if (reproduced.approvalProof() != actual.approvalProof()) {
    return GovernanceEvidenceValidationResult::rejected(
        ...
        "reproduced='" +
            reproduced.approvalProof() + "' stored='" + actual.approvalProof() +
            "'.");
  }
  ...
  if (reproduced.approvalId() != actual.approvalId()) {
    return GovernanceEvidenceValidationResult::rejected(
        ...
        "reproduced='" +
            reproduced.approvalId() + "' stored='" + actual.approvalId() +
            "'.");
  }
  ...
  if (reproduced.proposalId() != actual.proposalId()) {
    return GovernanceEvidenceValidationResult::rejected(
        ...
        "reproduced='" +
            reproduced.proposalId() + "' stored='" + actual.proposalId() +
            "'.");
  }
  ...
  if (reproduced.approver() != actual.approver()) {
    return GovernanceEvidenceValidationResult::rejected(
        ...
        "reproduced='" +
            reproduced.approver() + "' stored='" + actual.approver() + "'.");
  }
