...
ArtifactValidationResult::ArtifactValidationResult()
    : m_accepted(false),
      m_reason("Uninitialized artifact validation result."),
...
ArtifactValidationResult ArtifactValidationResult::rejected(
    std::string reason
) {
    ArtifactValidationResult result;
...
ArtifactValidationResult ArtifactValidationResult::appendRejected(
    std::string reason
) {
    ArtifactValidationResult result;
    result.m_accepted = false;
...
bool ArtifactValidationResult::accepted() const {
    return m_accepted;
}

const std::string& ArtifactValidationResult::reason() const {
    return m_reason;
}
