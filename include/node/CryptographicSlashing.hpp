...
public:
    ...
    static std::vector<CryptographicSlashingEvidenceRecord> buildEvidenceRecords(
        const std::vector<consensus::ValidatorVoteRecord>& votes,
        const crypto::CryptoPolicy& policy,
        const crypto::SignatureProvider& provider
    );

    static std::vector<CryptographicSlashingEvidenceRecord> buildEvidenceRecordsFromCertifiedVotes(
        const std::vector<consensus::ValidatorVoteRecord>& votes
    );
    ...
    static bool sameStakePenaltyRecords(
