...
public:
    ...
    static std::string stakePositionId(
    ...
    utils::Amount activeStake(
        const std::string& ownerAddress,
        const std::string& validatorAddress
    ) const;
    utils::Amount pendingActivationStake(
        const std::string& ownerAddress,
        const std::string& validatorAddress
    ) const;
    utils::Amount pendingUnbondingStake(
        const std::string& ownerAddress,
        const std::string& validatorAddress
    ) const;
    utils::Amount withdrawableStake(
        const std::string& ownerAddress,
        const std::string& validatorAddress,
        std::uint64_t blockHeight
    ) const;
    ...
    std::vector<StakePositionView> positionsForOwner(const std::string& ownerAddress) const;
...
private:
    ...
    StakePositionView viewFor(
        const std::string& validatorAddress,
        const std::string& ownerAddress,
        const Position& position
    ) const;

    void appendLifecycleRecord(
        std::string action,
        const std::string& transactionId,
        const std::string& ownerAddress,
        const std::string& validatorAddress,
    ...
    void rewriteAccountFromPositions(
        const std::string& validatorAddress,
        bool preserveJailed,
