...
struct JsonRpcResponse {
  ...
  static JsonRpcResponse success(const std::string &id,
                                 const std::string &result);
  static JsonRpcResponse makeError(const std::string &id, int code,
...
/*
 * JsonRpcDispatcher routes JSON-RPC 2.0 requests to registered handler
 * functions.
 *
 ...
 *   stake_deposit/topUp/unlock/withdraw params: {"transaction": "<serialized
 * signed tx>"} stake_pendingUnbonding     params: {"validator": "..."}
