...
public:
  ...
  SupplyLedgerSnapshot(std::uint64_t blockHeight, utils::Amount supplyBefore,
                       utils::Amount minted, utils::Amount burned,
                       utils::Amount treasuryDelta, utils::Amount supplyAfter);
...
public:
  ...
  MonetaryFirewallAudit(std::string status, SupplyLedgerSnapshot supplyLedger,
                        utils::Amount annualMintLimit,
                        utils::Amount annualMintUsedBefore,
                        utils::Amount annualMintUsedAfter, std::string policyId,
                        std::string reason);
...
public:
  static constexpr const char *ZERO_MINT_REASON = "MONETARY_FIREWALL_ZERO_MINT";
  ...
  static MonetaryFirewallAudit
  buildAudit(const config::GenesisConfig &genesisConfig,
             std::uint64_t blockHeight, utils::Amount minted,
             utils::Amount burned, utils::Amount treasuryDelta,
             utils::Amount annualMintUsedBefore);

  static MonetaryFirewallAudit
  buildAuditWithSupplyBefore(std::uint64_t blockHeight,
                             utils::Amount supplyBefore, utils::Amount minted,
                             utils::Amount burned, utils::Amount treasuryDelta,
                             utils::Amount annualMintUsedBefore);

  static MonetaryFirewallAudit buildEpochRewardAuditWithSupplyBefore(
      std::uint64_t blockHeight, utils::Amount supplyBefore,
      utils::Amount minted, utils::Amount burned, utils::Amount treasuryDelta,
      utils::Amount annualMintUsedBefore);

  static bool sameAudit(const MonetaryFirewallAudit &left,
