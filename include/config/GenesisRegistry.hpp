...
/*
 * GenesisRegistry is the single authority for registered genesis configurations.
 *
 ...
 * deterministic and clearly labeled. They must not be used in production networks.
 */
