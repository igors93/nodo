...
public:
   ...
   */
  static VoteCastResult
  submitAndBroadcastSignedVote(node::NodeRuntime &runtime,
                               const ValidatorVoteRecord &vote,
                               std::int64_t now, p2p::GossipMesh &gossip);
   ...
   */
  static VoteCastResult castPrevote(node::NodeRuntime &runtime,
                                    const core::Block &block,
                                    std::uint64_t round, std::int64_t now,
   ...
   */
  static VoteCastResult castPrecommit(node::NodeRuntime &runtime,
                                      const core::Block &block,
                                      std::uint64_t round, std::int64_t now,
                                      const crypto::Signer &signer,
                                      p2p::GossipMesh &gossip);
