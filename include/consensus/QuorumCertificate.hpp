...
std::string
quorumCertificateBuildStatusToString(QuorumCertificateBuildStatus status);
...
public:
  ...
  QuorumCertificate(std::uint64_t blockIndex, std::string blockHash,
  ...
  static QuorumCertificate deserialize(const std::string &serialized);
...
public:
  ...
  static QuorumCertificateBuildResult certified(QuorumCertificate certificate);

  static QuorumCertificateBuildResult
  rejected(QuorumCertificateBuildStatus status, std::string reason);
...
public:
  static std::uint64_t requiredVoteCount(std::uint64_t activeValidatorCount,
                                         std::uint64_t thresholdNumerator,
                                         std::uint64_t thresholdDenominator);

  static std::uint64_t requiredVotingWeight(std::uint64_t totalVotingWeight,
                                            std::uint64_t thresholdNumerator,
                                            std::uint64_t thresholdDenominator);

  static QuorumCertificateBuildResult
  buildFromVotes(std::uint64_t blockIndex, const std::string &blockHash,
