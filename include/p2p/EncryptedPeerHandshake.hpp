...
public:
  ...
  EncryptedPeerHandshakeHello(std::string nodeId,
                              std::string publicKeyFingerprint,
                              std::string nonceHex, std::int64_t createdAt);
...
public:
  ...
  EncryptedPeerHandshakeAccept(std::string responderNodeId,
...
enum class EncryptedPeerHandshakeStatus { ACCEPTED, REJECTED };

class EncryptedPeerHandshakeResult {
public:
  EncryptedPeerHandshakeResult();

  EncryptedPeerHandshakeResult(EncryptedPeerHandshakeStatus status,
                               std::string reason, std::string sessionId);
...
public:
  static EncryptedPeerHandshakeHello
  createHello(const std::string &nodeId,
              const std::string &publicKeyFingerprint, std::int64_t now);

  static EncryptedPeerHandshakeAccept
  createAccept(const EncryptedPeerHandshakeHello &hello,
               const std::string &responderNodeId,
               const std::string &responderFingerprint,
               const std::string &sharedSecret, std::int64_t now);

  static EncryptedPeerHandshakeResult
  validateAccept(const EncryptedPeerHandshakeHello &hello,
