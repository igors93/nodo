...
enum class NetworkMessageType {
  ...
  SLASHING_EVIDENCE_INVENTORY,
  SLASHING_EVIDENCE_REQUEST,
...
public:
  ...
  NetworkEnvelope(std::string networkId, std::string chainId,
                  std::string protocolVersion, NetworkMessageType messageType,
                  std::string senderNodeId, std::int64_t createdAt,
                  std::uint32_t ttlSeconds, std::string payload);
