...
public:
    ...
    static LocalSyncPlan noAction(
        std::string detail
    );

    static LocalSyncPlan requestBlocks(
        PeerInfo peer,
    ...
    static LocalSyncPlan rejectPeer(
        LocalSyncRejectReason reason,
        std::string detail
    );
...
public:
    ...
    static std::uint64_t firstSafeRequestHeight(
