...
public:
    ...
    virtual bool stageOutboundSession(
    ...
    virtual bool activateOutboundSession(
        const std::string& localNodeId,
        const std::string& remoteNodeId
    ) = 0;

    virtual bool establishInboundSession(
        const std::string& localNodeId,
        const std::string& remoteNodeId,
        const std::string& sharedSecret,
        std::int64_t now
    ...
    virtual bool hasInboundSession(
        const std::string& localNodeId,
        const std::string& remoteNodeId
    ) const = 0;
};
