...
public:
  ...
  BlockProductionConfig(std::size_t maxTransactionsPerBlock,
...
public:
  ...
  BlockProductionPlan(std::uint64_t blockIndex, std::string previousHash,
...
public:
  ...
  static BlockProductionResult produced(Block block, BlockProductionPlan plan);

  static BlockProductionResult rejected(BlockProductionStatus status,
                                        std::string reason);
