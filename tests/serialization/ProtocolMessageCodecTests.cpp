...
nodo::core::LedgerRecord ledgerRecord(
...
int main() {
    ...
    const nodo::core::Block genesis =
        nodo::core::Block::createGenesisBlock(
            {ledgerRecord("genesis", 1700000001)},
            1700000003
        );
    const nodo::core::Block child(
        1,
        genesis.hash(),
        {ledgerRecord("child", 1700000004)},
        1700000006
    );
    ...
    const auto decodedBlocks =
        nodo::serialization::ProtocolMessageCodec::decodeBlockList(blockListBytes);
    ...
    nodo::node::RoundAdvanceMessage roundAdvance(
        13,
        2,
        "validator-a",
        1700000010
    ...
    assert(
        nodo::serialization::ProtocolMessageCodec::hashRoundAdvanceMessage(roundAdvance) ==
        nodo::serialization::ProtocolMessageCodec::hashRoundAdvanceMessage(decodedRoundAdvance)
    );
