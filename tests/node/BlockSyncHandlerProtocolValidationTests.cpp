...
struct GossipPair {
    ...
    GossipPair()
        ...
        , transportA(bus)
        , transportB(bus)
        , meshA(p2p::GossipMeshConfig("node-a", "localnet", "chain-sync-test", "1", "genesis-id-sync", 60, 5, 100, 50), transportA)
        , meshB(p2p::GossipMeshConfig("node-b", "localnet", "chain-sync-test", "1", "genesis-id-sync", 60, 5, 100, 50), transportB)
    {
