...
void testStatusToString() {
    ...
    assert(syncHealthStatusToString(SyncHealthStatus::BATCH_FAILURE) == "BATCH_FAILURE");
    assert(syncHealthStatusToString(SyncHealthStatus::REQUEST_FAILURE) == "REQUEST_FAILURE");
    assert(syncHealthStatusToString(SyncHealthStatus::SERVE_FAILURE) == "SERVE_FAILURE");
